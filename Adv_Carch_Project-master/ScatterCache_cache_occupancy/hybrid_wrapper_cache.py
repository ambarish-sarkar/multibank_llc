...
# -*- coding: utf-8 -*-
"""
Hybrid Scatter Cache (MULTI-REGION, WAY-SPLIT, no tag duplication per line)

- Supports N independent Scatter Cache instances sharing the SAME set/index geometry.
