#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Simulator for occupancy-based covert channel with S-NUCA CEASER-S cache."""
...
class Simulator(object):
    ...
    def run_simulation(self,
        ...
        # Preserve current single-bank CEASER-S tag semantics; only the two
        # encrypted candidate set indexes become bank-local.
