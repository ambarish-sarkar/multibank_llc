...
# -*- coding: utf-8 -*-
"""
Main driver for covert-channel occupancy simulation (Mirage Hybrid)
"""
...
def run_experiment(receiver_addrs, sender_addrs, cli_args):
    ...
    timing_by_region = sim.run_simulation(
        ...
        num_additional_tags=cli_args.num_additional_tags,
    ...
    if cli_args.attack_mode == 'region0' or cli_args.num_banks == 1:
...
if __name__ == '__main__':
    ...
    print(f"Cache configuration (Mirage):")
    ...
    # Determine target banks for the S-NUCA attack.
    ...
    if cli_args.num_banks > 1:
        file_0 = f"../results/mirage/outfile_v1_bit_0_{cli_args.region_split_ratio}_{cli_args.attack_mode}_banks{cli_args.num_banks}_attack{cli_args.banks_to_attack}.txt"
        file_1 = f"../results/mirage/outfile_v1_bit_1_{cli_args.region_split_ratio}_{cli_args.attack_mode}_banks{cli_args.num_banks}_attack{cli_args.banks_to_attack}.txt"
    else:
        file_0 = f"../results/mirage/outfile_v1_bit_0_{cli_args.region_split_ratio}_{cli_args.attack_mode}.txt"
        file_1 = f"../results/mirage/outfile_v1_bit_1_{cli_args.region_split_ratio}_{cli_args.attack_mode}.txt"

    print("Starting Mirage covert channel experiment ...")
    ...
    print("\nMirage cache covert channel simulation completed!")
