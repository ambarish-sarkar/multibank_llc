...
if __name__ == '__main__':
    ...
    if cli_args.num_banks > 1:
        file_0 = f"../results/mirage/outfile_v1_bit_0_{cli_args.region_split_ratio}_{cli_args.attack_mode}_banks{cli_args.num_banks}_{target_banks_label}.txt"
        file_1 = f"../results/mirage/outfile_v1_bit_1_{cli_args.region_split_ratio}_{cli_args.attack_mode}_banks{cli_args.num_banks}_{target_banks_label}.txt"
    else:
