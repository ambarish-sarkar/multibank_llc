...
class writeFile(object):
    ...
    def write_indices_details(index1, index2):
        list_of_indices = [str(index1), str(index2)]
        with open('indices_list_simulator.txt','a') as filehandle:
            filehandle.writelines(list_of_indices)
            filehandle.writelines(" ,")
