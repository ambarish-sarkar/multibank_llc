#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Simulator for occupancy-based covert channel with S-NUCA CEASER cache."""
...
class Simulator(object):
    ...
    def run_simulation(self,
        ...
        # Tag generation intentionally preserves the previous single-bank CEASER
        # semantics; only the randomized set index becomes bank-local.
