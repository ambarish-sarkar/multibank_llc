...
# -*- coding: utf-8 -*-
"""
Main driver for covert-channel occupancy simulation (Normal Hybrid)
"""
...
if __name__ == '__main__':
    ...
    if cli_args.num_banks > 1:
        file_0 = f"../results/normal/outfile_v1_bit_0_{cli_args.region_split_ratio}_{cli_args.attack_mode}_banks{cli_args.num_banks}_attack{cli_args.banks_to_attack}.txt"
        file_1 = f"../results/normal/outfile_v1_bit_1_{cli_args.region_split_ratio}_{cli_args.attack_mode}_banks{cli_args.num_banks}_attack{cli_args.banks_to_attack}.txt"
    else:
        file_0 = f"../results/normal/outfile_v1_bit_0_{cli_args.region_split_ratio}_{cli_args.attack_mode}.txt"
        file_1 = f"../results/normal/outfile_v1_bit_1_{cli_args.region_split_ratio}_{cli_args.attack_mode}.txt"

    print("Starting Normal covert channel experiment ...")
    ...
    print("\nNormal cache covert channel simulation completed!")
