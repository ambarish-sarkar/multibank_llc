...
# -*- coding: utf-8 -*-
"""
Hybrid Normal Cache (MULTI-REGION, WAY-SPLIT, no tag duplication per line)

- Supports N independent Normal Cache instances sharing the SAME set/index geometry.
